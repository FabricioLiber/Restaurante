		...
		frmPrincipal.addWindowListener(new WindowAdapter() {
			...
			public void windowOpened(WindowEvent arg0) {
				try{
					...
					p = Fachada.cadastrarProduto("nigiri", 21.0);
					p = Fachada.cadastrarProduto("yakisoba", 10.0);
					p = Fachada.cadastrarProduto("chop suey", 10.0);
					Fachada.criarMesas(20);
					Garcom g;					
					g = Fachada.cadastrarGarcom("Fabricio", 1, 5);
					g = Fachada.cadastrarGarcom("Monitora", 6, 10);
					g = Fachada.cadastrarGarcom("Rafael", 11, 15);
					g = Fachada.cadastrarGarcom("Builder", 16, 20);
				}catch(Exception e){
