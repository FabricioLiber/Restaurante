	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (comboBox.getSelectedItem().equals(new String("Dinheiro"))) {
						p = Facade.pagarConta(Integer.parseInt(textFieldIdMesa.getText()), "dinheiro", Integer.parseInt(textFieldDesconto.getText()), "", 0);
						JOptionPane.showMessageDialog(contentPane, "Pagamento realizado!");
					} else if (comboBox.getSelectedItem().equals(new String("Cartao"))) {
						p = Facade.pagarConta(Integer.parseInt(textFieldIdMesa.getText()), "cartao", 0, textFieldNumCartao.getText(), Integer.parseInt(textfieldQtdParcelas.getText()));
						JOptionPane.showMessageDialog(contentPane, "Pagamento realizado!");
